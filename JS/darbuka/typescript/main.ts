const w = document.getElementById('sonido1') as HTMLDivElement;
...
const a = document.getElementById('sonido2') as HTMLDivElement;
...
const d = document.getElementById('sonido3') as HTMLDivElement;
...
const s = document.getElementById('sonido4') as HTMLDivElement;
...
const e = document.getElementById('sonido5') as HTMLDivElement;
